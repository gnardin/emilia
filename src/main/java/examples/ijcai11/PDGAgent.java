...
public class PDGAgent implements NormEnforcementListener {
   ...
   * @return none
   */
  public PDGAgent( int agentId, String xmlFile, String xsdFile, Map<NormEntityAbstract, List<SanctionEntityAbstract>> normsSanctions, Uniform rnd, double costPunish ) {
  ...
  public void updatePunishment(
    ...
    for ( Integer punisher : agentList ) {
      if ( punishments.containsKey( punisher ) ) {
        Map<Integer, SanctionEntityAbstract> punish = punishments
            .get( punisher );
