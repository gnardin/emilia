...
public class PDSim {
	...
	private static final Logger		logger					= LoggerFactory
																										.getLogger(PDSim.class);
	
	// Constants
	public final static Integer		numAgents				= 10;
	
	public final static Integer		numIteractions	= 100;
	...
	// Variables
	public Map<Integer, PDAgent>	agents;
	 ...
	 */
	public PDSim() {
		this.agents = new HashMap<Integer, PDAgent>();
	...
	public void init() {
		...
		for(Integer i = 0; i < numAgents; i++) {
			...
			agent = new PDAgent(i, xmlFile, xsdFile, normsSanctions, this.rnd,
					costPunish);
