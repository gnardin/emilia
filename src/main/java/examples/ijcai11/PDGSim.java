  ...
  public void run() {
    ...
    for ( Integer r = 0; r < timeSteps; r++ ) {
      ...
      for ( Object v : this.mGraph.vertexSet() ) {
        ...
        if ( (!paired.containsKey( source ))
            && (!paired.containsValue( source )) ) {
          boolean found = false;
