...
public class EmiliaEnforcementTest {
	...
	public void normEnforcementTest() {
		...
		ActionEvent cooperateEvent = new ActionEvent(Calendar.getInstance()
				.getTimeInMillis(), 1, 2, 1, new CooperateAction());
		controller.receive(cooperateEvent, this.normSanctions);
		
		ActionEvent defectEvent = new ActionEvent(Calendar.getInstance()
				.getTimeInMillis(), 1, 2, 1, new DefectAction());
